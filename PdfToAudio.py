...
book = open('/Users/monique/Desktop/mislead.pdf', 'rb') #mislead is the name of the PDF file that I have in my pythonProject2 folder in Computer
...
os.system("open mislead_audiobook.mp3")
